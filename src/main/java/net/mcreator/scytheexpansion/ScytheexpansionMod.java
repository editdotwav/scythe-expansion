...
@Mod("scytheexpansion")
public class ScytheexpansionMod {
	public static final Logger LOGGER = LogManager.getLogger(ScytheexpansionMod.class);
	public static final String MODID = "scytheexpansion";

	public ScytheexpansionMod() {
		MinecraftForge.EVENT_BUS.register(this);
		ScytheexpansionModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		ScytheexpansionModItems.REGISTRY.register(bus);
